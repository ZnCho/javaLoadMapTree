...
public class TestZone {
	...
	public static void main(String[] args) {
		ZonedDateTime seoulTime = ZonedDateTime.of(LocalDateTime.of(2024, 1, 1, 9, 00), ZoneId.of("Asia/Seoul"));
...
//		ZonedDateTime londonTime = ZonedDateTime.of(localDt, ZoneId.of("Europe/London"));
//		ZonedDateTime nyTime = ZonedDateTime.of(localDt, ZoneId.of("America/New_York"));
